...
[simplysf.github.io/simply-cli/gitlab](https://simplysf.github.io/simply-cli/gitlab/), built by
...
| ---------------------------------- | ------------------ |
| `packages/simply-gitlab/docs/`     | guides for the CLI |
| `packages/simply-gitlab-mcp/docs/` | the MCP guide      |
...
The `redirect/` directory keeps the old `simplysf.github.io/simply-gitlab/` URLs working by forwarding
